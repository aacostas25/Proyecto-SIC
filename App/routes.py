...
def resultados_sinteticos():
    ...
    capa0_1,capa1_1,capa2_1,errores_1,iteraciones,l3_error_1 = RN2(X_test1,Y_test2,x1,funcion2,eta = etaS,ite=iteracionesS,neuronas_1=neuronas1S,neuronas_2=neuronas2S)
    capa0_2,capa1_2,capa2_2,errores_2,iteraciones,l3_error_2 = RN2(X_test1,Y_test2,x1,funcion2,eta=etaS+0.002,neuronas_1=neuronas1S,neuronas_2=neuronas2S)
    capa0_3,capa1_3,capa2_3,errores_3,iteraciones,l3_error_3 = RN2(X_test1,Y_test2,x1,funcion2,eta=etaS-0.002,neuronas_1=neuronas1S,neuronas_2=neuronas2S)
    plt.clf()
    plt.figure()
